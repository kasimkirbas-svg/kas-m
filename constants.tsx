...
{ id: '1', title: '(RES, GES, HES, Termik) Yüksek Gerilim İşletme Sorumluluğu Atama Yazısı', category: 'Enerji Santralleri', fileUrl: '/templates/(RES, GES, HES, Termik)Yüksek Gerilim İşletme Sorumluluğu Atama Yazısıı.docx', fields: [{key: 'companyName', label: 'Santral / Firma Adı', type: 'text', required: true}, {key: 'date', label: 'Tarih', type: 'date'}, {key: 'sorumlu', label: 'Sorumlu Adı Soyadı', type: 'text'}, {key: 'tesis_gucu', label: 'Tesis Gücü', type: 'text'}] },
{ id: '2', title: 'Acil Durum Ekip Atama', category: 'Genel', fileUrl: '/templates/Acil_Durum_Ekip_Atama.docx', fields: [{key: 'companyName', label: 'Firma Adı', type: 'text', required: true}, {key: 'date', label: 'Tarih', type: 'date'}, {key: 'ekip_turu', label: 'Ekip Türü', type: 'select', options: ['Söndürme', 'Kurtarma', 'Koruma', 'İlk Yardım']}] },
