    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 p-4 md:p-8 pb-20">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <header className="mb-8 border-b border-slate-800 pb-4">
            ...
            <p className="text-slate-400 mt-2 font-medium">Uygulama tercihlerinizi buradan yönetebilirsiniz.</p>
        </header>
        ...
        <section className="bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-lg shadow-black/40 hover:border-slate-700 transition-colors">
            <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-black text-slate-100 uppercase tracking-tight">Dil Seçenekleri</h2>
            </div>
        ...
        <section className="bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-lg shadow-black/40 hover:border-slate-700 transition-colors">
            <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-black text-slate-100 uppercase tracking-tight">Görünüm</h2>
            </div>
             ...
             <div className="flex flex-wrap gap-4">
                ...
                >
                    ...
                    <span className={`font-black text-sm uppercase tracking-wider ${theme === 'dark' ? 'text-blue-400' : 'text-slate-400'}`}>Koyu Mod</span>
                </button>
                 <button 
                ...
                >
                    ...
                    <span className={`font-black text-sm uppercase tracking-wider ${theme === 'light' ? 'text-blue-400' : 'text-slate-400'}`}>Açık Mod</span>
                </button>
            </div>
        </section>
        ...
        <section className="bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-lg shadow-black/40 hover:border-slate-700 transition-colors">
             <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-xl font-black text-slate-100 uppercase tracking-tight">Bildirimler</h2>
                        <p className="text-xs font-bold text-slate-500 uppercase tracking-wide mt-1">Önemli güncellemelerden haberdar ol</p>
                    </div>
                </div>
                <button 
        ...
        <div className="pt-6 flex justify-end">
             <button className="bg-amber-500 hover:bg-amber-400 text-black font-black py-4 px-10 rounded-xl shadow-[0_0_20px_rgba(245,158,11,0.3)] hover:shadow-[0_0_30px_rgba(245,158,11,0.5)] flex items-center gap-3 active:scale-95 transition-all uppercase tracking-wide text-lg">
