    ...
    <div className="light-app-shell flex flex-col min-h-screen bg-[#eef1f5] dark:bg-[#0A0A0A] font-sans selection:bg-[#FFD700]/30 selection:text-slate-900 dark:text-white relative">
      ...
      <header className="flex items-center justify-between h-20 px-8 bg-white/85 dark:bg-[#0A0A0A]/90 backdrop-blur-md border-b border-slate-300/70 dark:border-white/5 relative z-50 shadow-[0_1px_0_rgba(15,23,42,0.04)] dark:shadow-none">
        ...
        >
          <div className="flex items-center gap-3">
             <div className="w-10 h-10 flex items-center justify-center rounded-full overflow-hidden bg-lightbox dark:bg-darkbox shadow-[0_0_15px_rgba(255,215,0,0.2)] group-hover:shadow-[0_0_20px_rgba(255,215,0,0.4)] transition-shadow border border-[#FFD700]/10">
               <img src="/logo.jpeg" alt="İSG Zeyron Logo" className="w-[120%] h-auto object-contain" />
             </div>
             <span className="font-black text-slate-900 dark:text-white text-xl tracking-[0.3em] uppercase drop-shadow-md">İSG ZEYRON</span>
          </div>
        </div>
        ...
        <div className="flex-1 flex justify-end items-center gap-6">
          <button 
            className="text-slate-600 dark:text-slate-400 hover:text-[#FFD700] transition-colors relative"
            title="Bildirimler"
          >
            <Bell size={20} />
          ...
          <div className="relative">
            ...
            >
              ...
              <ChevronDown size={14} className={`text-slate-600 dark:text-slate-400 transition-transform ${showUserMenu ? 'rotate-180' : ''}`} />
            </div>
      ...
      <div className="fixed bottom-8 right-8 flex flex-col gap-4 z-50">
        <button 
          ...
          className="bg-lightbox dark:bg-darkbox hover:bg-[#1a1a1a] text-[#FFD700] px-5 py-3 rounded-full font-bold shadow-[0_0_20px_rgba(255,215,0,0.1)] hover:shadow-[0_0_20px_rgba(255,215,0,0.3)] hover:-translate-y-1 transition-all border border-[#FFD700]/30 flex items-center gap-2 text-sm cursor-pointer shadow-lg">
