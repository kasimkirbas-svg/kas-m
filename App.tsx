      ...
      {user && currentView !== 'editor' && (
        <>
          ...
          <a 
            ...
            className="fixed bottom-6 left-6 z-[100] w-14 h-14 bg-[#25D366] hover:bg-[#20bd5a] text-white rounded-full flex items-center justify-center shadow-lg shadow-[#25D366]/30 hover:shadow-[#25D366]/50 hover:scale-110 hover:-translate-y-1 transition-all"
